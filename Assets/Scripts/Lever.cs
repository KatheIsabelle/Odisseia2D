...
public class Lever : MonoBehaviour
{
    ...
    private Dictionary<string, bool> pontosAtivos = new Dictionary<string, bool>();
                    ...
                    if (distance <= proximityDistance)
                    {
                        if (Input.GetKeyDown(KeyCode.Space))
                        {
                            ...
                            if (pontoUp != null && pontoDown != null)
                            {
                                ...
                                //Debug.Log("Ponto " + nomePontoUp + " ativado: " + pontosAtivos[nomePontoUp]);
                                ...
                                //Debug.Log("Ponto " + nomePontoDown + " ativado: " + pontosAtivos[nomePontoDown]);
